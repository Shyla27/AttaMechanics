...
public class NearbyGarages extends FragmentActivity implements OnMapReadyCallback , GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void onClick(View view) {
        ...
        switch(view.getId())
        {
            ...
            case R.id.B_garages:
                mMap.clear();
                String hospital = "garages";
                String url = getUrl(latitude, longitude, hospital);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;

                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(NearbyGarages.this, "Showing Nearby Garages", Toast.LENGTH_SHORT).show();
                break;
