...
import com.example.attamechanics.Adapters.EnumSelectionRecyclerViewAdapter;
import com.example.attamechanics.Callback.AddPairAlertDialogCallback;
import com.example.attamechanics.Callback.EmailUpdateCallback;
import com.example.attamechanics.Callback.EnumSelectionCallback;
import com.example.attamechanics.Callback.SMSUpdateCallback;
...
import com.example.attamechanics.Constants.RecyclerViewBuilder;
import com.example.attamechanics.Constants.Tag;
import com.example.attamechanics.Constants.Text;
import com.example.attamechanics.R;
import com.example.attamechanics.UI.CustomAlertDialogBuilder;
    ...
    public void createAddPairAlertDialog(String content, final ProfileUtil.FieldType field, final AddPairAlertDialogCallback callback) {
        ...
        addPairAlertDialog.setPositiveButton(Text.BUTTON_ADD, new DialogInterface.OnClickListener() {
            ...
            public void onClick(final DialogInterface dialog, int which) {
                ...
                if (Utils.isBoolean(pairStringValue)) {
                    pairValue = Boolean.parseBoolean(pairStringValue.toLowerCase());
                } else if (Utils.isNumeric(pairStringValue)) {
