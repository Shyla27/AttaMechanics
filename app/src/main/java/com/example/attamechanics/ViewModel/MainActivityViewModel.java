...
import com.example.attamechanics.Adapters.InAppMessageRecyclerViewAdapter;
import com.example.attamechanics.Adapters.NotificationRecyclerViewAdapter;
import com.example.attamechanics.Adapters.PairRecyclerViewAdapter;
import com.example.attamechanics.Callback.AddPairAlertDialogCallback;
import com.example.attamechanics.Callback.PairItemActionCallback;
import com.example.attamechanics.Callback.UpdateAlertDialogCallback;
import com.example.attamechanics.Constants.CurrentUser;
import com.example.attamechanics.Constants.Notification;
import com.example.attamechanics.Constants.Text;
import com.example.attamechanics.R;
import com.example.attamechanics.UI.InAppMessage;
import com.example.attamechanics.UI.RecyclerViewBuilder;
import com.example.attamechanics.Users.UserSignUp;
import com.example.attamechanics.Utils.Animate;
import com.example.attamechanics.Utils.Dialog;
import com.example.attamechanics.Utils.Font;
import com.example.attamechanics.Utils.IntentTo;
import com.example.attamechanics.Utils.ProfileUtil;
import com.example.attamechanics.Utils.SharedPreferenceUtil;
...
public class MainActivityViewModel extends ActivityViewModel {
    ...
    public ActivityViewModel onActivityCreated(Context context) {
        ...
        navigateNextActivity.setOnClickListener(v -> {
            getActivity().startActivity(new Intent(getActivity(), UserSignUp.class));
        });
        tagSet = new HashMap<>();
