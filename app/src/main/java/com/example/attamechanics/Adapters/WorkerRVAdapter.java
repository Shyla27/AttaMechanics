...
import com.example.attamechanics.Fragments.MechDetails.WorkerDetailsViewModel;
...
public class WorkerRVAdapter extends RecyclerView.Adapter<WorkerRVAdapter.ViewHolder> {
    ...
    public WorkerRVAdapter(WorkerDetailsViewModel workerDetailsViewModel, Context mContext) {
        ...
        @NonNull
        @Override
        public WorkerRVAdapter.ViewHolder onCreateViewHolder (@NonNull ViewGroup parent,int viewType)
        {
        ...
        @Override
        public void onBindViewHolder (@NonNull WorkerRVAdapter.ViewHolder holder,int position){
            ...
            holder.ll_worker_item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, MechProfile.class);
